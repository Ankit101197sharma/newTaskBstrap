import React from 'react'
 ...
 function Contact() {
  return (
    ...
    <form  target="_blank">
      <p><input class="form-control padding16" type="text" placeholder="Name" required="" name="Name"/></p>
      ...
      <p><button style={{backgroundColor:'grey'}} class="btn btn-secondary " type="submit">SEND MESSAGE</button></p>
    </form>
        </div>
        
    </div>
    <div style={{padding:'24px'}} className='text-center'>Powered By www.google.com</div>
    </>
  )
}
